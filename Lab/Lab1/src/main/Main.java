...
public class Main {
	...
	public static void removeDepartmentFromDatabase(int index) {
		...
		ArrayList<GuildMember> x = myDatabase.removeDepartment(index);
		...
		getUnassignedDepartment().addMultipleMembers(x);
		...
		System.out.println("The department is removed. "+x.size()+" member(s) are moved to Unassigned Department.");
	}
